...
def args_parser():
     ...
     parser.add_argument('--root_path', type=str, default='/research/pheng4/qdliu/hzyang/flsemi/adam/data/rsna/output/stage_2_train', help='dataset root dir')
     parser.add_argument('--csv_file_train', type=str, default='/research/pheng4/qdliu/hzyang/flsemi/adam/training.csv', help='training set csv file')
     ...
     parser.add_argument('--csv_file_test', type=str, default='/research/pheng4/qdliu/hzyang/flsemi/adam/testing.csv', help='testing set csv file')
